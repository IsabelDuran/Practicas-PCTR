 ...
 * ESPECIFICACIONES: el programa ilustra el uso de los metodos  
 * necesarios para medir el tiempo de ejecucion de un programa o de  
...
public class medTemporal
{
  ...
  public static void main(String[] args)
  {
    ...
    Arrays.sort(datos);   //se ordena el array de numeros
